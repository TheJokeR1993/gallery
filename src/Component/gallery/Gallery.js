...
import {
  ...
  R_F_change_limit,
  R_F_change_page,
} from "../../redux/gallery/reduce_Gallery";
...
const Gallery = ({
  ...
  return (
    <div className="gallery">
      <PaginationLimit
        page={reducer_Gallery.page}
        limit={reducer_Gallery.limit}
        R_F_change_limit={R_F_change_limit}
      />
      ...
      <PaginationPage
        limit={reducer_Gallery.limit}
        max={look_photo.length}
        page={reducer_Gallery.page}
        R_F_change_page={R_F_change_page}
      />
    </div>
  );
};
